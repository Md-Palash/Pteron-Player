        ...
        Column(modifier = Modifier.padding(bottom = 24.dp)) {
            ...
            if (onLoadExternal != null) {
                ListItem(
                    ...
                    supportingContent = { Text(".srt, .vtt, or .ass from your device") },
                    leadingContent = { Icon(Icons.Outlined.FileOpen, contentDescription = null) },
                    modifier = Modifier
                        .fillMaxWidth()
                        .pointerInput(Unit) { detectTapAndSelect { onLoadExternal() } }
                )
            }
            if (tracks.isEmpty()) {
                Text(
            ...
            if (allowDisable) {
                ListItem(
                    ...
                    leadingContent = { Icon(Icons.Outlined.SubtitlesOff, contentDescription = null) },
                    modifier = Modifier
                        .fillMaxWidth()
